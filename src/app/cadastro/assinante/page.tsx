    ...
    try {
      const response = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({
          ...formData,
          role: "ASSINANTE",
          subscriptionStatus: "PENDING", // Será atualizado após o pagamento
          subscriptionType: "BASIC", // Tipo básico inicial
        }),
      })
      ...
      toast.success("Conta criada com sucesso! Você será redirecionado para escolher seu plano.")
        ...
        >
          <div className="backdrop-blur-xl bg-white/80 p-8 rounded-2xl shadow-2xl border border-white/50">
            <div className="flex flex-col items-center space-y-2 mb-8">
              ...
              <p className="text-gray-600">Comece sua jornada premium agora</p>
            </div>
