...
export default function MaisPesquisadosPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Ordena produtos por número de pesquisas
        const sortedProducts = [...data].sort((a: Product, b: Product) => (b.searchCount || 0) - (a.searchCount || 0))
      ...
      <main className="flex-1 py-8">
        <div className="container mx-auto space-y-8">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">Mais Pesquisados</h1>
